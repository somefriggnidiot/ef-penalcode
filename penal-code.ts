...
const PenalCode: PenalCode[] = [
...

  {
    ...
    statutes: {
      ...
      23: {
        title: "Smuggling of Precious Gemstones",
        class: "Felony",
        id: 2023,
        months: 10,
        fine: 5000,
      ...
      24: {
        title: "Smuggling of Precious Metals",
        class: "Felony",
        id: 2024,
        months: 15,
        fine: 6000,
      ...
      25: {
        ...
        months: 1,
        fine: 1500,
        description: "A person who knowingly provides false information, false documentation, or misrepresents the nature, value, or quantity of goods to customs or other government authorities for the purpose of evading duties, taxes, or regulations is guilty under this code section.",
      },
      26: {
        title: "Operating an Unlicensed Import/Export Business",
        class: "Felony",
        id: 2026,
        months: 50,
        fine: 20000,
        description: "A person who operates a commercial import or export business without proper licensing, permits, or registration required by government authorities, or who conducts import/export activities on a commercial scale while evading regulatory oversight, is guilty under this code section. Transportation personnel including drivers, pilots, or vessel operators who knowingly participate in unlicensed commercial import/export operations are also guilty under this code section. Commercial scale is defined as: (1) importing/exporting goods valued at $50,000+ per transaction or $150,000+ aggregate over one month, (2) conducting 4+ import/export transactions within one month, (3) importing/exporting goods exceeding 200 kg per shipment, (4) operating with dedicated business infrastructure or commercial documentation, or (5) clear evidence of conducting activities for financial gain as a business venture.",
      },
      27: {
        title: "Accessory to Smuggling",
        class: "Misdemeanor",
        id: 2027,
        months: 5,
        fine: 1000,
        description: "A person who, without directly committing the act of smuggling, knowingly aids, assists, abets, or facilitates the commission of smuggling by another person, including providing transportation, storage, documentation, or other support services, is guilty under this code section.",
      },
    },
  },
